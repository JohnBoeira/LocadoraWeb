...
export class CupomListarComponent implements OnInit {
  ...
  constructor(private router: Router, @Inject('IHttpCupomServiceToken') private servicoCupom: IHttpCupomService, private servicoModal: NgbModal, private toastService : ToastService) { }
