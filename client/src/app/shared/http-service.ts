...
export class HttpService<EntityListViewModel, EntityCreateViewModel extends EntityViewModel, EntityDetailsViewModel extends EntityViewModel, EntityEditViewModel extends EntityViewModel> 
{
    ...
    public obterEntidade(): Observable<EntityListViewModel[]> {
        return this.http.get<EntityListViewModel[]>(`${this.apiUrl}`);
    }

    public obterEntidades(entidade: EntityCreateViewModel): Observable<EntityCreateViewModel> {
